	...
	<body>
		...
		<div id="show-task" class="content scaffold-show" role="main">
			...
			<ol class="property-list task">
				...
				<g:if test="${taskInstance?.duration}">
				<li class="fieldcontain">
					<span id="duration-label" class="property-label"><g:message code="task.duration.label" default="Duration" /></span>
					
						<span class="property-value" aria-labelledby="duration-label"><g:fieldValue bean="${taskInstance}" field="duration"/></span>
